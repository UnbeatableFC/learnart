...
export const navbarStyles = {
  ...
  desktopNavContainer: "flex items-center space-x-1 bg-white/80 backdrop-blur-sm rounded-2xl py-1.5 px-2.5 shadow-sm border gap-5 border-gray-200 ",
  ...
  mobileMenuItems: "flex flex-col space-y-2",
  ...
  mobileMenuIconContainer: "flex items-center p-4 rounded-lg bg-blue-50 transition-colors duration-300",
  mobileMenuIcon: "text-blue-600",
  mobileMenuText: "ml-4 font-medium text-gray-700",
