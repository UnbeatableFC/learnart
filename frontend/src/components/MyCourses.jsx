...
const MyCourses = () => {
    ...
    const fetchMyCourses = async () => {
      ...
      try {
        ...
        if (!bookingsJson || bookingsJson.success === false) {
          throw new Error(
            (bookingsJson && bookingsJson.message) ||
        ...
        const uiCourses = valid.map(({ booking, course }) => ({
          ...
          id:
            ...
            booking.courseId,
          name:
            course.name ?? booking.courseName ?? "Untitled Course",
  ...
  const handleSetRating = async (e, courseId, rating) => {
    ...
    if (!signed) {
      toast("Please sign in to submit your rating", { icon: "⭐" });
      return;
    }
          ...
          {courses.map((course, index) => (
            <div
              ...
              style={{
                ...
                animation: `fadeInUp 0.6s ease-out ${index * 100}ms`,
              }}
              role="button"
              tabIndex={0}
              onKeyDown={(e) => {
            ...
            >
              ...
              <div className={myCoursesStyles.courseContent}>
                <h3 className={myCoursesStyles.courseName}>
                  {course.name}
                </h3>
                ...
                >
                  <Plane className={myCoursesStyles.buttonIcon} />
