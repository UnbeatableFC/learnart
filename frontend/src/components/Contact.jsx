...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const whatsappUrl = `https://wa.me/+2347032191259?text=${whatsappMessage}`;
              ...
              >
                ...
                >
                  {isSubmitting ? (
                    ...
                    <>
                      <SendHorizonal
                        className={contactStyles.submitIcon}
                      />
                      Send Message
                    </>
                  )}
        ...
        <div className={contactStyles.footer}>
          <div className={contactStyles.footerBadge}>
            ...
            <span className={contactStyles.footerText}>
              All messages are sent directly to WhatsApp for immediate
              response.
            </span>
          </div>
        </div>
