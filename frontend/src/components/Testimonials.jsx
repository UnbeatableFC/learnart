...
const Testimonials = () => {
  ...
  const onMouseMove = (e, el, index) => {
    ...
    if (badge) {
      badge.style.transform = `translate3d(${tx * 0.2}px, ${
        ty * 0.2
      }px, 30px)`;
    }
  };
    ...
    <section className={testimonialStyles.section}>
      <div className={testimonialStyles.container}>
        ...
        <p className={testimonialStyles.subtitle}>
          Discover how our learners transformed their careers with
          hands-on project and expert mentorship.
        </p>
      </div>
      ...
      <div className={testimonialStyles.grid}>
        {testimonials.map((t, i) => (
          <div
            onMouseMove={(e) =>
              onMouseMove(e, cardsRef.current[i], i)
            }
          ...
          >
            ...
            >
              ...
              <div className={testimonialStyles.courseBadge}>
                <div
                  className={testimonialStyles.courseBadgeDot}
                ></div>
                ...
                <div className={testimonialStyles.userInfo}>
                  <div className={testimonialStyles.userHeader}>
                    <div className="min-w-0">
                      <h3 className={testimonialStyles.userName}>
                        {t.name}
                      </h3>
                      <p className={testimonialStyles.userRole}>
                        {t.role}
                      </p>
                    </div>
                    <div
                      className={testimonialStyles.ratingContainer}
                    >
                      <div
                        className={testimonialStyles.starsContainer}
                      >
              ...
              <div className={testimonialStyles.footer}>
                ...
                <div className={testimonialStyles.date}>
                  <CalendarDays
                    className={testimonialStyles.dateIcon}
                  />
                  <span>2026</span>
                </div>
              </div>
