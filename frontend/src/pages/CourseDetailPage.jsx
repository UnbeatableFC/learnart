  ...
  return (
    ...
    >
      <div className={courseDetailStyles.toastContent}>
        ...
        <button
          onClick={onClose}
          className={courseDetailStyles.toastClose}
        >
...
const CourseDetailPage = () => {
  ...
  //   Initialize the enrollment state based on course type
  useEffect(() => {
    if (isCourseFree) {
  ...
  const salePrice =
    hasPriceObj && priceObj.sale != null
      ? Number(priceObj.sale)
      : null;
  const originalPrice =
    hasPriceObj && priceObj.original != null
  ...
  //   This is to toggle the course to be marked completed
  ...
  const currentEmbedUrl = currentRawUrl
    ? toEmbedUrl(currentRawUrl)
    : null;
    ...
    <div className={courseDetailStyles.container}>
      ...
      >
        ...
        <div className={courseDetailStyles.header}>
          ...
          <h1 className={courseDetailStyles.title}>
            ...
            <div className={courseDetailStyles.videoContainer}>
              ...
              {currentEmbedUrl ? (
                ...
                <div className={courseDetailStyles.videoPlaceholder}>
                  <div
                    className={courseDetailStyles.videoPlaceholderBg}
                  >
                    <div
                      className={
              ...
              <div className={courseDetailStyles.videoInfo}>
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p
                      className={courseDetailStyles.videoDescription}
                    >
                    ...
                    {currentVideoContent?.durationMin && (
                      <div className={courseDetailStyles.videoMeta}>
                        <div
                          className={courseDetailStyles.durationBadge}
                        >
                          <Clock
                            className={
                ...
                {isLoggedIn &&
                  ...
                  selectedContent.chapterId && (
                    <div
                      className={courseDetailStyles.completionSection}
                    >
                      <button
                        onClick={() =>
                      ...
                      <p
                        className={courseDetailStyles.completionText}
                      >
                        {completedChapters.has(
                          selectedContent.chapterId
                        )
          ...
          <aside className={courseDetailStyles.sidebar}>
              ...
              <div className={courseDetailStyles.contentHeader}>
                ...
                {isCourseFree && (
                  <div className={courseDetailStyles.freeBadge}>
                    <Sparkles
                      className={courseDetailStyles.freeBadgeIcon}
                    />
                    Free Access
                  </div>
                )}
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <div
                            className={courseDetailStyles.lectureInfo}
                          >
                            <div
                              className={
            ...
            >
              <div className={courseDetailStyles.pricingHeader}>
                <h5 className={courseDetailStyles.pricingTitle}>
                  Pricing
                </h5>
              </div>
              ...
              <div className="mt-6">
                {isCourseFree ? (
                  ...
                  >
                    <CheckCircle
                      className={courseDetailStyles.enrollIcon}
                    />
              ...
              <div className={courseDetailStyles.progressContent}>
                ...
                <div className={courseDetailStyles.progressStats}>
                  <div className={courseDetailStyles.progressStat}>
                    <div
                      className={courseDetailStyles.progressStatValue}
                    >
                      {fmtMinutes(totalMinutes)}
                    </div>
                    <div
                      className={courseDetailStyles.progressStatLabel}
                    >
                      Total Duration
                    </div>
                  </div>
