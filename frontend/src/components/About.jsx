      ...
      <section className={aboutUsStyles.heroSection}>
        ...
        <div className={aboutUsStyles.heroContent}>
          ...
          <div className={aboutUsStyles.statsGrid}>
            {statsMeta.slice(0, 4).map((stat, ind) => (
              <div
                key={ind}
              ...
              >
                ...
                <div className={aboutUsStyles.statLabel}>
                  {stat.label}
                </div>
              </div>
            ))}
        ...
        <div className={aboutUsStyles.sectionGrid}>
          <div className={aboutUsStyles.teamHeader}>
            ...
            <p className={aboutUsStyles.teamSubtitle}>
              Passionate educators, innovators and vissionaries
              dedicated to your success.
            </p>
          </div>
          <div className={aboutUsStyles.teamGrid}>
            {teamMembers.map((member, ind) => (
              <div key={ind} className={aboutUsStyles.teamMember}>
        ...
        <div className={aboutUsStyles.sectionGrid}>
          <div className={aboutUsStyles.testimonialsHeader}>
            ...
            <p className={aboutUsStyles.testimonialsSubtitle}>
              Real stories from real learners who transformed their
              careers
            </p>
          </div>
            ...
            {testimonials.map((testimonial, index) => (
              ...
              >
                ...
                <div className={aboutUsStyles.testimonialAuthor}>
                  ...
                  <div>
                    <div
                      className={aboutUsStyles.testimonialAuthorName}
                    >
                      {testimonial.name}
                    </div>
                    <div
                      className={aboutUsStyles.testimonialAuthorRole}
                    >
                      {testimonial.role}
                    </div>
                  </div>
      ...
      <section className={aboutUsStyles.ctaSection}>
        ...
        <div className={aboutUsStyles.ctaContent}>
          ...
          <p className={aboutUsStyles.ctaDescription}>
            Join millions of learners who have transformed their lives
            with LearnHub. Start your journey today with a 7-day free
            trial.
          </p>
          ...
          <div className={aboutUsStyles.ctaButtons}>
            <a href="/contact" className={aboutUsStyles.ctaButton}>
              <MessageCircleCode
                className={aboutUsStyles.ctaButtonIcon}
              />
              Talk to Advisor
            </a>
          </div>
