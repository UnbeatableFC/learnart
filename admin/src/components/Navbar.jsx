...
const Navbar = () => {
  ...
  //   Close menu when clicked outside the nav
  useEffect(() => {
    ...
    <>
      <nav className={navbarStyles.nav(isVisible)}>
        <div className={navbarStyles.navContainer}>
          <div
            className={navbarStyles.navInner(isMenuOpen)}
            ref={menuRef}
          >
                    ...
                    ({ id, label, icon: Icon, path }) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className="lg:text-base xl:text-lg md:text-xs ">
                            {label}
                          </span>
                          ...
                          {isActive && (
                            <span
                              className={
                                navbarStyles.desktopActiveGlow
                              }
                            />
                          )}
                        </Link>
